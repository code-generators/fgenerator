...
<div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="{{$tableColumn}}" value="" required lay-verify="required" placeholder="请输入{{$tableColumn}}" class="layui-input">
                                        </div>
                                    </div>
                                    @endforeach
    ...
    <script>
        layui.config({
            ...
            form.on('submit(add)', function(data){
                ...
                *.post('<%route('{{lcfirst($group)}}.{{lcfirst($module)}}.{{lcfirst($model)}}.add')%>', data.field , function(response){
